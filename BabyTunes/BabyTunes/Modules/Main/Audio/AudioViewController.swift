...
class AudioViewController: UIViewController,AVAudioPlayerDelegate {
    ...
    func startAudioVisualizer() {
        ...
        visualizerTimer = Timer.scheduledTimer(timeInterval: visualizerAnimationDuration, target: self, selector: #selector(visualizerTimerChanged(_:)), userInfo: nil, repeats: true)
